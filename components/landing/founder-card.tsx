  ...
  return (
    <div className="bg-gray-100 rounded-lg p-3 ">
      ...
      <p className="text-gray-600 text-sm mt-3 max-w-xs font-medium">
        I run cold outreach for my own products. I built MonchoOps because
        every cold-DM tool I tried either burned my accounts, leaked my data,
        or charged me per contact for results I could get with a desktop app.
      </p>
      <p className="text-gray-400 text-xs mt-2 max-w-xs">
        I&apos;m a software engineer who spent {yearsInWords} years building
        tools founders actually ship with. MonchoOps is the result of solving

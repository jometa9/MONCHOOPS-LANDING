...
const shortQuestions = [
  ...
  "Can I run 10 accounts on one machine?",
...
const allQuestions = [
  ...
  "How long should I warm an account?",
  ...shortQuestions,
];
        ...
        <div className="group relative overflow-hidden rounded-lg bg-gray-800 xl:mx-3 p-8 py-20 pb-30 hover:bg-gray-750 transition-colors cursor-pointer">
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            ...
            <p className="text-gray-400 text-lg mb-8 max-w-xl">
              Our AI assistant knows everything about MonchoOps.
              <br />
            ...
            <div className="mt-6 flex flex-wrap justify-center gap-3">
              {["Setup", "Warmup", "Proxies", "Scraping", "Compliance"].map((chip) => (
                <div
                  key={chip}
